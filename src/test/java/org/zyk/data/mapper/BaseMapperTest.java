...
public class BaseMapperTest {
    ...
    public void shortValueTest() throws IOException {
        ShortValueBean putBean1 = new ShortValueBean("1", (short) 10, (short) 20, (short) 30, (short) 40);
        mapper.put(putBean1);
        ShortValueBean getBean = mapper.get("1", ShortValueBean.class);
        Assert.assertEquals(putBean1, getBean);

        putBean1 = new ShortValueBean("2", (short) 11, (short) 20, (short) 30, (short) 40);
        mapper.put(putBean1);
    ...
    public void scanTest() throws IOException {
        ...
        List<List<Object>> list = mapper.scan("1", "3", "test_table", Arrays.asList(Double.class, double.class),
                Arrays.asList("double:value", "double:valuePrimitive"));
