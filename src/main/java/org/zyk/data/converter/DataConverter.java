...
import org.zyk.data.exception.DataConvertException;
...
public interface DataConverter {
     ...
     * @return byte数组表示的元数据
     */
    default byte[] convert2MetaData(Object data) {
        ...
        throw new DataConvertException("unsupport convert metadata type:" + type);
    }
     ...
     * @return 转化后的java类型对象
     */
    Object data2JavaObject(byte[] bytes, Class<?> type);
     ...
     * @return 转化后的byte数组对象
     */
    byte[] javaObject2Data(Object data);
}
