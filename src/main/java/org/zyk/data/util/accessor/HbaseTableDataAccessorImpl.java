...
public class HbaseTableDataAccessorImpl implements HbaseTableDataAccessor {
    ...
    public static HbaseTableDataAccessor create(TableName tableName, HbaseClient hbaseClient) throws IOException {
        return new HbaseTableDataAccessorImpl(tableName, hbaseClient);
    }

    private HbaseTableDataAccessorImpl(TableName tableName, HbaseClient hbaseClient) throws IOException {
